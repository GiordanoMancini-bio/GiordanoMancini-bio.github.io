...
<div style="display:flex; align-items:center; margin-bottom:40px; flex-wrap:wrap;">
  ...
  <div style="flex:2; text-align:justify">
    ...
    <p>
      My work for the GaP project focused on applying and testing KBA Criterion E, which identifies higly irreplaceable areas through spatial prioritization analysis. More info soon!
    </p>
  </div>
</div>
...
<div style="display:flex; align-items:center; margin-bottom:40px; flex-wrap:wrap;">
  ...
  <div style="flex:2; text-align:justify">
    ...
    <p>
      My work for the sRedList project focused on standardizing the integration of climate change responses into IUCN Red List assessments. Learn more <a href="https://doi.org/10.1111/cobi.14227">here</a>.
    </p>
  </div>
</div>
